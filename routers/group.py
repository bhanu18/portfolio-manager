...
from db.dependencies import get_db, get_current_active_user, get_current_active_admin_user, get_current_group_admin
...
async def create_group(group_in: group_schema.GroupCreate,
...
@router.delete("/{group_id}/members/{user_id}", response_model=group_schema.GroupWithMembers, tags=["Admin"])
